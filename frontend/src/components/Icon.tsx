...
const PATHS: Record<string, string> = {
  ...
  library: 'M4 4.5h6v6H4zM14 4.5h6v6h-6zM4 13.5h6v6H4zM14 13.5h6v6h-6z',
  history: 'M12 7v5l3.5 2M3.6 12a8.4 8.4 0 1 0 2.5-6M3.5 5.5V10h4.5',
  mic: 'M12 4.5a2.7 2.7 0 0 1 2.7 2.7v4.6a2.7 2.7 0 0 1-5.4 0V7.2A2.7 2.7 0 0 1 12 4.5M5.5 11.5a6.5 6.5 0 0 0 13 0M12 18v2.5',
  ...
  cancel: 'M12 3a9 9 0 1 1 0 18 9 9 0 0 1 0-18M9.2 9.2l5.6 5.6M14.8 9.2l-5.6 5.6',
  // Feuille avec un signet — un scénario déposé.
  script: 'M6.5 3.6h11v16.8l-5.5-3.4-5.5 3.4zM9.2 8h5.6M9.2 11.4h5.6',
};
