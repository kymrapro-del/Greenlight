 ...
 * - `md-outlined-text-field` — le champ de recherche du rapport, avec son
 *   libellé flottant, son contour interrompu et sa gestion du focus. Le
 *   redessiner à la main reviendrait à réécrire le composant le plus détaillé
 *   de la spécification.
 *
